...
async function check() {
    try {
        ...
        // Check for cache buster comment if possible, but bundle check is better
        if (html.includes('Cache Buster v1.5.17.4')) {
            console.log('✅ Found Cache Buster comment in index.html');
        } else {
            console.log('⚠️ Cache Buster comment MISSING in index.html');
        }
