...
// Keys from keys_dump_2.json (Second Sub)
const raw = fs.readFileSync('keys_dump_2.json', 'utf-8');
...
(async () => {
    try {
        const payload = JSON.stringify({
            notification: {
                title: "🚨 MANUAL 2 (Alert)",
                body: "Checking if this ID (6ba24) is the live one.",
